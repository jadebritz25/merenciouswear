    ...
    <section id="testimonials" className="py-24 bg-cream">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((t) => (
            <div key={t.name} className="border border-gold/30 p-8 bg-white/40">
              <p className="text-gold text-3xl font-heading mb-4">"</p>
              <p className="text-ink/65 text-sm leading-relaxed italic font-body mb-6">{t.quote}</p>
              <div className="w-8 h-px bg-gold mb-4" />
              <p className="text-ink font-body font-semibold text-sm">{t.name}</p>
