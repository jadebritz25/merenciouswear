      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="text-center">
            ...
            <p className="text-ink/65 text-sm font-body leading-relaxed">
              Klerksdorp, North West &amp; Johannesburg
              <br />
              <span className="text-ink/45 text-xs italic">
          ...
          <div className="text-center">
            ...
            <a
              ...
              className="block text-ink/65 text-sm font-body hover:text-gold transition-colors"
            >
              0626 270 767
            </a>
            <a
              href="mailto:MerenciousWear@gmail.com"
              className="block text-ink/65 text-sm font-body hover:text-gold transition-colors mt-1"
            >
          ...
          <div className="text-center">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-ink/65 text-sm font-body hover:text-gold transition-colors"
            >
              @merenciouswear
            </a>
          </div>
        ...
        <div className="border-t border-gold/20 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <p className="text-ink/25 text-xs font-body">
            Website by{' '}
            <a
